      ...
      <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="../img/slide_1.jpg" width="1100" height="300">
          </div>
          <div class="carousel-item">
            <img src="../img/lib_slide_1.jpg" width="1100" height="300">
          </div>
          <div class="carousel-item">
            <img src="../img/lib_slide_2.jpg" width="1100" height="300">
          </div>
    ...
    <div class="wrapper fadeInDown">
      <div id="formContent">
        ...
        <div class="fadeIn first">
          <img src="../img/logo.png" style="width: 40%" id="icon" alt="User Icon" />
        </div>
        ...
        <!-- Remind Passowrd -->
        <div id="formFooter">
          <a class="underlineHover"  name="login" >Developed By Kausar Ahmed</a>
        </div>
